...
def test_promote_target_for_waf() -> None:
    ...
    url, port = promote_target_for_waf("http://example.com:80/attack", "CFB")
    ...
    url_tls, port_tls = promote_target_for_waf("http://example.com", "TLS")
    ...
    url_udp, port_udp = promote_target_for_waf("http://example.com:80", "UDP")
